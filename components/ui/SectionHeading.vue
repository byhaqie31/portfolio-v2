...
defineProps<{
  label: string      // small eyebrow label e.g. "Selected Work"
...
<template>
  <div class="reveal mb-16">
    <!-- Eyebrow with divider line (Axelnova pattern) -->
    ...
    <p v-if="description" class="max-w-xl text-text-secondary leading-relaxed">
      {{ description }}
    </p>
  </div>
</template>
